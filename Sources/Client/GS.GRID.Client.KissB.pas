...
public
  ...
  procedure CheckMsgWait(var MessageBox : TGRIDMessages);
...
begin
  ...
  Assert(assigned(Transport));
  CheckConnected;
  FSplProcessStep_APIInfo_Response.Clear;
