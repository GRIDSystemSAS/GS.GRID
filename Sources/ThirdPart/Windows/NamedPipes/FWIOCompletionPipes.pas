...
type
  ...
  public
    ...
    Procedure disconnect(aPipeHandle : THandle);

    property Active: Boolean read GetActive write SetActive;
    property ServerReadyToServe : boolean read FReadyToServe;
...
procedure TFWPipeServer.disconnect(aPipeHandle: THandle);
var i : Integer;
    PipeInstance: PFWPipeData;
begin
  for I := FPipeInstances.Count - 1 downto 0 do
  begin
    PipeInstance := FPipeInstances[i];
    if PipeInstance^.PipeHandle = aPipeHandle then
    begin
